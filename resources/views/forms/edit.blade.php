<body>
    <form action="{{ route('casos.salvaredit',$editar->id)}}" method="POST">
        @csrf

        <div class="card">
            <div class="card-header">
                <h5 class="col-12 modal-title text-center">Edição de registro de casos</h5>
             </div>
            ...
            <div class="form-row ">
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                       ...
                       value="{{isset($editar->dia) ? $editar->dia->format('Y-m-d') : old('dia', $editar->dia->format('Y-m-d'))}}"/>                     </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="casos" class="control-label">Total de casos do dia:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="casos" name="casos" value="{{old('casos',$editar->casos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="obitos" name="obitos" value="{{old('obitos',$editar->obitos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="recuperados" name="recuperados" value="{{old('recuperados',$editar->recuperados)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="suspeitos" name="suspeitos" value="{{old('suspeitos',$formulario->suspeitos)}}" />
                    </div>
                </div>
                {{-- <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        name="testesNegativos" value="{{old('testesNegativos',$formulario->testesNegativos)}}"/>
                    </div>
                </div>
                <div class="form-group col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        name="exames" value="{{old('exames',$formulario->exames)}}"/>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="total_leitos_clinicos" name="total_leitos_clinicos"
                            value="{{old('total_leitos_clinicos',$editar->total_leitos_clinicos)}}" />
                    </div>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="leitos_clinicos_em_uso" name="leitos_clinicos_em_uso"
                            value="{{old('leitos_clinicos_em_uso',$editar->leitos_clinicos_em_uso)}}" />
                    </div>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="total_leitos_uti" name="total_leitos_uti"
                            value="{{old('total_leitos_uti',$editar->total_leitos_uti)}}" />
                    </div>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="leitos_uti_em_uso" name="leitos_uti_em_uso"
                            value="{{old('leitos_uti_em_uso',$editar->leitos_uti_em_uso)}}" />
                    </div>
                </div>

                <div class="form-group col-md-6">
                    <label for="total_leitos_upa" class="control-label">Total de Leitos UPA:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="total_leitos_upa" name="total_leitos_upa"
                            value="{{old('total_leitos_upa',$editar->total_leitos_upa)}}" />
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label for="leitos_upa_em_uso" class="control-label">Leitos UPA em uso:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="leitos_upa_em_uso" name="leitos_upa_em_uso"
                            value="{{old('leitos_upa_em_uso',$editar->leitos_upa_em_uso)}}" />
                    </div>
                </div>
            ...
            <div class="form-row ">
                ...
                @foreach ($bairros as $bairro)
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="{{ $bairro->id }}_casos"
                        name="{{ $bairro->id }}_casos" value="{{isset($bairro->casos) ? old($bairro->id.'_casos', $bairro->casos) : old($bairro->id .'_casos', '0')}}" />
                    </div>
                @endforeach
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="masculino" name="masculino" value="{{old('masculino',$editar->masculino)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="feminino" name="feminino" value="{{old('feminino',$editar->feminino)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="ate1ano" name="ate1ano" value="{{old('ate1ano',$editar->ate1ano)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de1a4anos" name="de1a4anos" value="{{old('de1a4anos',$editar->de1a4anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de5a9anos" name="de5a9anos" value="{{old('de5a9anos',$editar->de5a9anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de10a14anos" name="de10a14anos" value="{{old('de10a14anos',$editar->de10a14anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de15a19anos" name="de15a19anos" value="{{old('de15a19anos',$editar->de15a19anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de20a29anos" name="de20a29anos" value="{{old('de20a29anos',$editar->de20a29anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de30a39anos" name="de30a39anos" value="{{old('de30a39anos',$editar->de30a39anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de40a49anos" name="de40a49anos" value="{{old('de40a49anos',$editar->de40a49anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de50a59anos" name="de50a59anos" value="{{old('de50a59anos',$editar->de50a59anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de60a69anos" name="de60a69anos" value="{{old('de60a69anos',$editar->de60a69anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de70a79anos" name="de70a79anos" value="{{old('de70a79anos',$editar->de70a79anos)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="de80oumais" name="de80oumais" value="{{old('de80oumais',$editar->de80oumais)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="branca" name="branca" value="{{old('branca',$editar->branca)}}" />
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <label for="parda" class="control-label">Parda:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="parda" name="parda" value="{{old('parda',$editar->parda)}}"/>
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <label for="preta" class="control-label">Preta:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="preta" name="preta" value="{{old('preta',$editar->preta)}}" />
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <label for="amarela" class="control-label">Amarela:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="amarela" name="amarela" value="{{old('amarela',$editar->amarela)}}" />
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <label for="indigena" class="control-label">Indigena:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="indigena" name="indigena" value="{{old('indigena',$editar->indigena)}}" />
                    </div>
                </div>
                <div class="form-group col-md-3">
                    <label for="cor_raca_nao_informada" class="control-label">Cor/Raça não informada:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="cor_raca_nao_informada" name="cor_raca_nao_informada" value="{{old('cor_raca_nao_informada',$editar->cor_raca_nao_informada)}}" />
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="analfabeto" name="analfabeto" value="{{old('analfabeto',$editar->analfabeto)}}" />
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="ensino_fundamental" class="control-label">Ensino Fundamental:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="ensino_fundamental" name="ensino_fundamental" value="{{old('ensino_fundamental',$editar->ensino_fundamental)}}" />
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="ensino_medio" class="control-label">Ensino Médio:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="ensino_medio" name="ensino_medio" value="{{old('ensino_medio',$editar->ensino_medio)}}" />
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="ensino_superior" class="control-label">Ensino Superior:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="ensino_superior" name="ensino_superior" value="{{old('ensino_superior',$editar->ensino_superior)}}" />
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="escolaridade_nao_informada" class="control-label">Escolaridade não informada:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="escolaridade_nao_informada" name="escolaridade_nao_informada" value="{{old('escolaridade_nao_informada',$editar->escolaridade_nao_informada)}}" />
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label for="nao_aplicado" class="control-label">Não se aplica:</label>
                    <div class="input-group">
                        <input type="number" min="0" onkeypress="return event.charCode >= 48" class="form-control" id="nao_aplicado" name="nao_aplicado" value="{{old('nao_aplicado',$editar->nao_aplicado)}}" />
                    </div>
                </div>
